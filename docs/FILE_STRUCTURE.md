...
UAV-VLA-Lab/
  ...
  tools/                            # Numeric export, charts and validation
  pyproject.toml                    # Project metadata and dependencies
  CITATION.cff                      # Software citation
  LICENSE, THIRD_PARTY_NOTICES.md   # Project and upstream terms
```

Start with the [short study note](research/technical-report.md) and the [recorded results](research/results.md). The [experiment directory](../experiments/simulation-sft-v1/README.md) contains the numeric data behind the figures. Short videos play in the README; the [video note](research/videos.md) links the original recordings and explains the selection.
