...
from uav_vla_lab.datasets import reviewed as dataset_contract
...
def load_reference_contract():
    source = legacy_script("prepare_published_reference")
...
def main(argv=None):
    ...
    report["code"] = {"runner": file_record(__file__), "dataset_contract": file_record(dataset_contract.__file__), "upstream": validate_upstream(options.upstream)}
